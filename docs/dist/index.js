...
var validationSchema = [
  ...
  create$6().shape({
    plates: create$7().of(create$6().shape({
      ...
      price: create$4().required("It wasn’t free lol").positive("You got paid to eat??").integer(),
      eatenBy: create$7().of(create$3()).min(1, "Someone has to eat it!")
    })).min(1, "No food, no website")
  }),
  create$6().shape({
    price: create$4().required("It wasn’t free lol").positive("You got paid to eat??").integer(),
    tip: create$4().required("If you didn’t tip this app breaks").positive("You got paid to eat??").integer()
  })
];
